...
/*!
 ...
 - Remark: 聊天室
 */
- (void)setChatRoomStatusDelegate:(id<RCChatRoomStatusDelegate>)delegate __deprecated_msg("Use [RCChatRoomClient addChatRoomStatusDelegate:] instead");
...
- Remark: 功能设置
*/
- (void)setRCChatRoomKVStatusChangeDelegate:(id<RCChatRoomKVStatusChangeDelegate>)delegate __deprecated_msg("Use [RCChatRoomClient addChatRoomKVStatusChangeDelegate:] instead");
@end
