...
/*!
 ...
 - Parameter delegate: IMLib 聊天室状态监听器
 */
- (void)removeChatRoomStatusDelegate:(id<RCChatRoomStatusDelegate>)delegate NS_SWIFT_NAME(removeChatRoomStatusDelegate(_:));
 ...
 */
- (void)addChatRoomKVStatusChangeDelegate:(id<RCChatRoomKVStatusChangeDelegate>)delegate NS_SWIFT_NAME(addChatRoomKVStatusChangeDelegate(_:));
...
/*!
 ...
 - Parameter delegate: 代理
 */
- (void)removeChatRoomKVStatusChangeDelegate:(id<RCChatRoomKVStatusChangeDelegate>)delegate NS_SWIFT_NAME(removeChatRoomKVStatusChangeDelegate(_:));
...
/**
 ...
 - Since: 5.4.5
 */
- (void)addChatRoomNotifyEventDelegate:(id<RCChatRoomNotifyEventDelegate>)delegate NS_SWIFT_NAME(addChatRoomNotifyEventDelegate(_:));
...
/**
 ...
 - Since: 5.4.5
 */
- (void)removeChatRoomNotifyEventDelegate:(id<RCChatRoomNotifyEventDelegate>)delegate NS_SWIFT_NAME(removeChatRoomNotifyEventDelegate(_:));
