...
- (nullable RCMessage *)insertOutgoingMessage:(RCConversationType)conversationType
                                   ...
                                   sentStatus:(RCSentStatus)sentStatus
                                      content:(RCMessageContent *)content
                                     sentTime:(long long)sentTime __deprecated_msg("Use [RCChannelClient insertOutgoingMessage:targetId:channelId:canIncludeExpansion:sentStatus:content:sentTime:completion:] instead");
...
- (void)insertOutgoingMessage:(RCConversationType)conversationType
                   ...
                   completion:(nullable void(^)(RCMessage * _Nullable message))completion __deprecated_msg("Use [RCChannelClient insertOutgoingMessage:targetId:channelId:canIncludeExpansion:sentStatus:content:sentTime:completion:] instead");
...
- (nullable RCMessage *)insertIncomingMessage:(RCConversationType)conversationType
                               ...
                               receivedStatus:(RCReceivedStatus)receivedStatus
                                      content:(RCMessageContent *)content
                                     sentTime:(long long)sentTime __deprecated_msg("Use [RCChannelClient insertIncomingMessage:targetId:channelId:senderUserId:receivedStatusInfo:content:sentTime:completion:] instead");
...
- (void)insertIncomingMessage:(RCConversationType)conversationType
               ...
               receivedStatus:(RCReceivedStatus)receivedStatus
                      content:(RCMessageContent *)content
                     sentTime:(long long)sentTime
                   completion:(nullable void(^)(RCMessage * _Nullable message))completion __deprecated_msg("Use [RCChannelClient insertIncomingMessage:targetId:channelId:senderUserId:receivedStatusInfo:content:sentTime:completion:] instead");
...
/// userIdLis t里 ID 个数不能超过 300，超过会被截断。
/// 
...
- (nullable NSArray<RCMessage *> *)getLatestMessages:(RCConversationType)conversationType
                                            targetId:(NSString *)targetId
                                           channelId:(nullable NSString *)channelId
                                               count:(int)count __deprecated_msg("Use [RCChannelClient getLatestMessages:targetId:channelId:count:completion:] instead");
...
- (void)getRemoteHistoryMessages:(RCConversationType)conversationType
                      ...
                      recordTime:(long long)recordTime
                         ...
                         success:(nullable void (^)(NSArray <RCMessage *> *messages, BOOL isRemaining))successBlock
                           error:(nullable void (^)(RCErrorCode status))errorBlock __deprecated_msg("Use [RCChannelClient getRemoteHistoryMessages:targetId:channelId:option:success:error:] instead");
...
/// 如果您使用IMKit，此方法会屏蔽该会话的所有提醒（远程推送、本地通知、前台提示音）,该接口不支持聊天室。
/// 
/// - Remark: 会话
/// - Since: 5.1.1
...
/// 
/// conversationTypeList 包含超级群会话类型时，超级群会话只搜索已存储到本地的消息记录。
/// conversationTypeList中类型个数不能超过300，超过会被截断。
