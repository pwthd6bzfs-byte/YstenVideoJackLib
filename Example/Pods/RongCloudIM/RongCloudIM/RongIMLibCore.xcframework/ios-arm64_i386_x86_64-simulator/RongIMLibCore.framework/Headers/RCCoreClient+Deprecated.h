...
/// - Remark: 功能设置
/// - Since: 5.0.0
- (void)setRCConnectionStatusChangeDelegate:(id<RCConnectionStatusChangeDelegate>)delegate __deprecated_msg("Use [RCCoreClient addConnectionStatusChangeDelegate:] instead");
...
/// - Remark: 功能设置
/// - Since: 5.0.0
- (void)setReceiveMessageDelegate:(id<RCIMClientReceiveMessageDelegate>)delegate object:(nullable id)userData __deprecated_msg("Use [RCCoreClient addReceiveMessageDelegate:] instead");
...
/// - Remark: 高级功能
/// - Since: 5.0.0
- (void)recordLaunchOptionsEvent:(nullable NSDictionary *)launchOptions __deprecated_msg("Remote notification use [RCCoreClient recordRemoteNotificationEvent:] instead, local notification use [RCCoreClient recordLocalNotificationResponseEvent:] instead");
...
- (void)recordLocalNotificationEvent:(UILocalNotification *)notification __deprecated_msg("Use [RCCoreClient recordLocalNotificationResponseEvent:] instead");
...
- (void)createGroup:(RCGroupInfo *)groupInfo
     inviteeUserIds:(nullable NSArray<NSString *> *)inviteeUserIds
            success:(void (^)(RCErrorCode processCode))successBlock
              error:(void (^)(RCErrorCode errorCode, NSString * _Nullable errorKey))errorBlock __deprecated_msg("Use -[RCCoreClient createGroup:inviteeUserIds:successBlock:errorBlock:] instead");
...
- (void)updateGroupInfo:(RCGroupInfo *)groupInfo
                success:(void (^)(void))successBlock
                  error:(void (^)(RCErrorCode errorCode, NSString * _Nullable errorKey))errorBlock NS_SWIFT_NAME(updateGroupInfo(_:success:error:)) __deprecated_msg("Use -[RCCoreClient updateGroupInfo:successBlock:errorBlock:] instead");
...
- (void)setGroupMemberInfo:(NSString *)groupId
                  ...
                  nickname:(nullable NSString *)nickname
                   ...
                   success:(void (^)(void))successBlock
                     error:(void (^)(RCErrorCode errorCode))errorBlock __deprecated_msg("Use -[RCCoreClient setGroupMemberInfo:userId:nickname:extra:successBlock:errorBlock:] instead");
...
- (void)updateMyUserProfile:(RCUserProfile *)profile
                    success:(nullable void (^)(void))successBlock
                      error:(nullable void (^)(RCErrorCode errorCode, NSString * _Nullable errorKey))errorBlock __deprecated_msg("Use -[RCCoreClient updateMyUserProfile:successBlock:errorBlock:] instead");
...
- (void)setFriendInfo:(NSString *)userId
           ...
           extProfile:(nullable NSDictionary<NSString *, NSString*> *)extProfile
              success:(void (^)(void))successBlock
                error:(void (^)(RCErrorCode errorCode))errorBlock __deprecated_msg("Use -[RCCoreClient setFriendInfo:remark:extProfile:successBlock:errorBlock:] instead");
