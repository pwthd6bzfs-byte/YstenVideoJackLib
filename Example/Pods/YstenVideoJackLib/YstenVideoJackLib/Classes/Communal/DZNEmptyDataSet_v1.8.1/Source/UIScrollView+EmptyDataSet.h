...
// 图片与标题间间距
- (CGFloat)spaceHeight_image_title_ForEmptyDataSet:(UIScrollView *)scrollView;
// 标题与描述间间距
- (CGFloat)spaceHeight_title_description_ForEmptyDataSet:(UIScrollView *)scrollView;
// 描述与按钮间间距
- (CGFloat)spaceHeight_description_button_ForEmptyDataSet:(UIScrollView *)scrollView;
@end
