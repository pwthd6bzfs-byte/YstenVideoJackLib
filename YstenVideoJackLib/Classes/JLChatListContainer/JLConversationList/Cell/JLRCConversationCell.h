...
/*!
 会话Cell类
 */
@interface JLRCConversationCell : RCConversationBaseCell
...
@property (nonatomic, strong) RCloudImageView *newHeaderView;
...
/*!
 Cell消息数量标签(容器)
 */
@property (nonatomic, strong) UIView *bubbleViewContent;
